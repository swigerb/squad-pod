...
| --- | --- | --- | --- |
| Homer Simpson | 🏗️ Lead | review | System architecture, code review, technical decision-making, unblocking the team |
| Lisa Simpson | 🔧 Core Dev / Extension Developer | edit | VS Code Extension API, TypeScript, esbuild bundling, file system watchers, Squad framework internals |
| Bart Simpson | ⚛️ Frontend Dev | advisory | React 19, Canvas 2D rendering, pixel art animation systems, game loops, webview UX |
| Marge Simpson | 🧪 Tester | review | VS Code extension testing (@vscode/test-electron, @vscode/test-web), Vitest, integration testing, e… |
| Ned Flanders | 📝 DevRel | edit | Technical writing, README authoring, VS Code Marketplace listings, developer guides, onboarding docs |

### Supported task types

🏗️ Lead, 🔧 Core Dev / Extension Developer, ⚛️ Frontend Dev, 🧪 Tester, 📝 DevRel
...
- **Can:** review code and pull requests; write and modify code; write and run tests; write and maintain documentation; author and maintain CI/CD workflows; UX and visual design
- **Cannot (no agent claims this):** security and secrets review; responsible-AI and content-safety review; cut releases and publish packages; deploy to live environments
